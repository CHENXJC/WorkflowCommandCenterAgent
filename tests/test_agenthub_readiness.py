...
def test_agent_manifest_has_agenthub_ready_contract():
    ...
    assert manifest["status"] == "agenthub-ready-local"
    ...
    assert manifest["next_recommended_action"] == "WCC-003-GITHUB-SHOWCASE-PREP"
...
def test_release_manifest_states_not_public_release_or_agenthub_modified():
    ...
    assert manifest["next_stage"] == "WCC-003-GITHUB-SHOWCASE-PREP"
